...
//  AntAR
//
//  Shared speech-bubble presentation — originally private to LostAntChatBubbleView, extracted so
//  the same visual language can be reused for the UFO story beats and the block-placement hint.
//
